...
generated_imgs = generated_imgs.reshape((64,64*64*3))


g_image_score = gmm.score(generated_imgs)
pred_g = gmm.predict(generated_imgs)
print(g_image_score, pred_g)

pred_train = gmm.predict(images_test)
closest_img = images_test[pred_train==pred_g[0]]
closest_img = closest_img.reshape((-1,64,64,3))
save_images(closest_img, [ni, ni], 'samples/image_interpolation_real.png')
